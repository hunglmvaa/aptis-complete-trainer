...
const APP_VERSION="3.9.1", USER_PK="aptis_v33_user_packs", ONLINE_PK="aptis_v34_online_cache", LEGACY_PK="aptis_v32_packs", SK="aptis_v32_state", VK="aptis_v32_voice";
...
function l2KeyData(x){
  const k=(window.L2_CANONICAL_KEY_BANK||{})[x?.id];
  if(k)return k;
